...
Player::Player(char _shootDir, int _timeDelay, int _xCheckpoint, int _yCheckpoint, int _xPos, int _yPos, int _health) : Object{_xPos, _yPos, char(24), char(25), false},
